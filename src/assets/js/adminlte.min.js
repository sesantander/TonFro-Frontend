                ...
                E = function() {
                    ...
                    return n.show = function() {
                        ...
                        return this.each((function() {
                            var s = t(this).data(i);
                            if (s || (s = new e(this, t(this).data()), t(this).data(i, s)), "undefined" === s[n]) throw new Error(n + " is not a function");
                            s[n]()
                        }))
                    }, e
                }();
            ...
            var e = "CardWidget",
                ...
                l = function() {
                    ...
                    return i.collapse = function() {
                        ...
                        n || (n = new e(t(this), n), t(this).data("lte.cardwidget", "string" == typeof i ? n : i)), "string" == typeof i && i.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/) ? n[i]() : "object" == typeof i && n._init(t(this))
                    }, e
                }();
                ...
                m = function() {
                    ...
                    return i.create = function() {
                        ...
                        if (0 === t(this._getContainerId()).length) {
                            ...
                            this._config.position == f ? e.addClass(l) : this._config.position == u ? e.addClass(c) : this._config.position == g ? e.addClass(d) : this._config.position == _ && e.addClass(h), t("body").append(e)
                        }
